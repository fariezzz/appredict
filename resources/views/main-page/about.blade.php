            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    ...
                    <p class="lead text-muted" style="font-size: 18px">
                        Proyek ini dikembangkan sebagai bagian dari tugas kuliah kami, dengan tujuan menerapkan ilmu
                        matematika dan pemrograman ke dalam sebuah aplikasi nyata.
                        <br><br>
                        Kami berharap Appredict bisa menjadi contoh sederhana bagaimana data historis dapat digunakan untuk
                        membantu pengguna membuat keputusan pembelian yang lebih bijak, terutama saat ingin membeli iPhone.
                    </p>
                </div>
                <div class="col-md-6 text-center">
                    <img src="{{ asset('images/teamwork.jpg') }}" alt="Ilustrasi Proyek" class="img-fluid"
                        style="max-width: 80%">
                </div>
            </div>
        </div>
    ...
    <section class="py-5">
        <div class="container">
            ...
            <div class="row justify-content-center mb-3">
                <div class="col-6 col-md-4 col-lg-3 col-xl-5ths d-flex justify-content-center">
                    <div class="team-card">
                        <img src="{{ asset('images/fariez2.jpg') }}" class="team-photo team-fariez"
                            alt="Muhammad Fariez Riziq Ilham">
                ...
                <div class="col-6 col-md-4 col-lg-3 col-xl-5ths d-flex justify-content-center">
                    <div class="team-card">
                        <img src="{{ asset('images/fathir.jpg') }}" class="team-photo team-fathir"
                            alt="Fathir Rizki Fadillah">
                        <div class="team-overlay text-center">
                ...
                <div class="col-6 col-md-4 col-lg-3 col-xl-5ths d-flex justify-content-center">
                    <div class="team-card">
                        <img src="{{ asset('images/andhara.jpg') }}" class="team-photo team-andhara"
                            alt="Andhara Febry Pitriana">
                        <div class="team-overlay text-center">
